...
namespace MedicMod.Modules.Survivors
{
    internal class MyCharacter : SurvivorBase
    {
        ...
        internal override void InitializeSkills()
        {
            ...
            string prefix = MedicPlugin.developerPrefix;
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(MedicPlugin.developerPrefix + "_HENRY_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(MedicPlugin.developerPrefix + "_HENRY_BODY_MASTERY_SKIN_NAME",
